(function () {
  ...
  var translations = {
    en: {
      ...
      'hero.scroll':  'SCROLL',
      'about.label':  'ABOUT',
      'about.heading': '<em>I train without excuse. <br>I dress with precision. <br>Neither is up for debate.</em>',
    ...
    zh: {
      ...
      'hero.scroll':  '\u5411\u4e0b',
      'about.label':  '\u5173\u4e8e',
      'about.heading': '<em>\u8bad\u7ec3\uff0c\u6ca1\u6709\u501f\u53e3\u3002<br>\u7740\u88c5\uff0c\u7cbe\u51c6\u5230\u4f4d\u3002<br>\u4e24\u8005\u7686\u4e0d\u5bb9\u7f6e\u7591\u3002</em>',
